...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/LoremIpsum/css/adminMember/adminMemberCreate.css" />
...
<body>
	<div id="wrapper">
		...
		<main>
			<h3>新增會員</h3>
			<form action="/LoremIpsum/adminMember/create" method="post">
				<table>
					<tr>
						<td>帳號:</td>
					...
					<tr>
						<td>權限:</td>
						<td>
							<input type="radio" name="type" value="host">管理員
							<input type="radio" name="type" value="user">用戶
						</td>
					</tr>
					<tr>
						<td colspan="2">
